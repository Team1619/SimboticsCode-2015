...
public class DriveToPoint extends AutonCommand {
	...
	public DriveToPoint(Vect point, double heading, int errorEps, boolean AccelerationControl , long timeout, boolean goFaster, double maxSpeed) {
	...
	public DriveToPoint(Vect point, double heading, int errorEps, boolean AccelerationControl, boolean goFaster) {
		this(point, heading, errorEps, AccelerationControl, -1,goFaster,1.0);
	}
	
	public DriveToPoint(Vect point, double heading, int errorEps,boolean AccelerationControl ,long timeout){
		this(point,heading,errorEps,AccelerationControl,timeout,false,1.0);
	}
	
	public DriveToPoint(Vect point, double heading, int errorEps, boolean AccelerationControl){
		this(point,heading,errorEps,AccelerationControl,-1,false,1.0);
	}
	
	public DriveToPoint(Vect point, double heading, int errorEps, long timeout){
		this(point,heading,errorEps,true,timeout,false,1.0);
	}
	
	public DriveToPoint(Vect point, double heading , int errorEps, double maxSpeed){
		this(point,heading,errorEps,true,-1,false,maxSpeed);
	}
	
	public DriveToPoint(Vect point, double heading, int errorEps){
