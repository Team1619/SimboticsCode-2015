...
public class ThreeToteStackInZone implements AutonMode {
	...
	public AutonCommand[] getMode() {
		...
		ab.addCommand(new DriveToPoint(new Vect(-200, 70), 180,this.largeEps,false,2000,false,1.0));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new IntakeSetSpeed(0.0));
		
		ab.addCommand(new DriveToPoint(new Vect(-308, 139), 180,this.smallEps,false,3000,false,1.0));
		ab.addCommand(new DriveWait());
		...
		//ab.addCommand(new IndexerWait()); // can remove to save time
		ab.addCommand(new DriveToPoint(new Vect(-232, 139), 180,this.smallEps,false,-1,false,0.85));
		ab.addCommand(new DriveWait());
