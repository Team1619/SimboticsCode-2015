...
public class SlowCanburgle4Left implements AutonMode {
	...
	//	ab.addCommand(new CanburglarWait());
		...
		ab.addCommand(new DriveToPoint(new Vect(AutonControl.Canburgle_XChange, -96), 270, 1));  // back up to edge of totes
