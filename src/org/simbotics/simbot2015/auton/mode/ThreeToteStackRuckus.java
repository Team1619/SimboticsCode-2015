...
public class ThreeToteStackRuckus implements AutonMode {
	...
	public AutonCommand[] getMode() {
		...
		ab.addCommand(new DriveAtSpeedFpsUntilLightSensor(6.5, 180,1.0,true ,2500,true)); // drive until sees second tote
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveAtSpeedFpsUntilLightSensor(7.5, 180,1.0,true,2500,true)); // drives until it sees 3rd tote 
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveToPoint(new Vect(-185, 70), 165,25,true,2000,true,1.0));
		...
		ab.addCommand(new DriveToPoint(new Vect(-243, 153), 135,4,false,3500,false,1.0));
		ab.addCommand(new DriveWait());
		...
		//ab.addCommand(new IndexerWait()); // can remove to save time
		ab.addCommand(new DriveToPoint(new Vect(-214.5, 124.5), 135,5,true,-1,true,1.0));
		ab.addCommand(new DriveWait());
