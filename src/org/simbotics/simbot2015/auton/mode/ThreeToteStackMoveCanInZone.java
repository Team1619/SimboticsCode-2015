...
public class ThreeToteStackMoveCanInZone implements AutonMode {
	...
	public AutonCommand[] getMode() {
		...
		ab.addCommand(new DriveToPoint(new Vect(-155,-6), 180,this.smallEps,1500)); // add more x?
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveToPoint(new Vect(-314, 139), 180,this.smallEps,false,3000,false,1.0));
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveToPoint(new Vect(-220, 139), 180,this.smallEps,false,-1,false,0.85));
		ab.addCommand(new DriveWait());
