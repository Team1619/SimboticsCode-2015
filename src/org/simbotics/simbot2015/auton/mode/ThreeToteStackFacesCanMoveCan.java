...
public class ThreeToteStackFacesCanMoveCan implements AutonMode {
	...
	public AutonCommand[] getMode() {
		...
		ab.addCommand(new DriveToPoint(new Vect(-65, -5), 180,this.largeEps,2500)); // might need to add more x come in to grab 2nd tote
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new IntakeSetSpeed(-1));

		ab.addCommand(new DriveAtSpeedUntilLightSensor(0.7, 180,true ,2500,true)); // drive until sees second tote
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new IndexerToteSequence(0.5));
		...
		ab.addCommand(new DriveToPoint(new Vect(-155, 27), 210,this.largeEps,true,1500,true,1.0)); // add more x? 
		ab.addCommand(new DriveWait());
		
		
		ab.addCommand(new DriveToPoint(new Vect(-155,-3), 180,this.smallEps,1500)); // add more x?
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new IndexerLastToteSequence()); // we have the 3rd tote 
		//ab.addCommand(new IndexerWait()); // can remove to save time
		
		//ab.addCommand(new DriveToPoint(new Vect(-205, 0), 180,this.largeEps,false,2000,false,1.0));
		//ab.addCommand(new DriveWait());
		
		
		
		ab.addCommand(new DriveToPoint(new Vect(-205, 60), 180,this.largeEps,false,2000,false,1.0));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new IntakeSetSpeed(0.0));
		
		ab.addCommand(new DriveToPoint(new Vect(-245, 165), 90,this.smallEps,false,2500,false,1.0));
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveToPoint(new Vect(-245, 100), 90,this.smallEps,false,-1,false,1.0));
		ab.addCommand(new DriveWait());
		
		//ab.addCommand(new DriveToPoint(new Vect(-260, 100), 90,this.smallEps,false));
		//ab.addCommand(new DriveWait());
