...
public class SlowCanburgleFakeRightBurgleLeft implements AutonMode {
	...
	public AutonCommand[] getMode() {
		...
		//ab.addCommand(new DriveToPoint(new Vect(-AutonControl.Canburgle_XChange, -96), 270, 1,0.6)); // pull it forward
